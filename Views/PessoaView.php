...
<head>
                  ...
                  <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel">Cadastro geral</h5>
  ...
  <tbody>
    <tr>
      ...
      <td>Otto</td>
      <td>@mdo</td>
      <td><button class="btnEditar" value="1">Editar</button><button class="btnExcluir" value="1">Excluir</button>
    </tr>
    <tr>
      <th scope="row">2</th>
      <td>Jacob</td>
      <td>Thornton</td>
      <td>@fat</td>
      <td><button class="btnEditar">Editar</button><button class="btnExcluir">Excluir</button>
    </tr>
    <tr>
      <th scope="row">3</th>
